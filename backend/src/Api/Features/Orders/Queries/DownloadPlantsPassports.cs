...
public static class DownloadPlantsPassports
{
    public sealed class Endpoint : ICarterModule
    {
        public void AddRoutes(IEndpointRouteBuilder app)
        {
            app.MapGet(
                ...
                .WithName(nameof(DownloadPlantsPassports))
                .WithTags(nameof(Order))
                .WithOpenApi(o =>
                {
                    o.Summary = "Download plants passports";
                    return o;
                });
        }
    }
    ...
    public sealed class Handler(AppDbContext context, IFileSystemService fileSystemService) : IRequestHandler<Query, Result<FileStream>>
    {
        public async Task<Result<FileStream>> Handle(Query message, CancellationToken cancellationToken)
        {
            ...
            var fileQuery = context.UserFiles.Where(file => file.FileIdentifier == FileIdentifier.PlantPassport);
