...
namespace Fei.Is.Api.Data.Configuration.LifeCycleSystem
{
    public class EditorBoardConfiguration : IEntityTypeConfiguration<EditorBoard>
    {
        public void Configure(EntityTypeBuilder<EditorBoard> builder)
        {
            ...
            builder.Property(b => b.EditorBoardID)
                .IsRequired()
                .HasMaxLength(100);
            ...
            builder.Property(b => b.PosX)
                .IsRequired();

            builder.Property(b => b.PosY)
                .IsRequired();

            builder.Property(b => b.Shape)
                .IsRequired()
                .HasMaxLength(100);
            ...
            builder.HasOne(b => b.GreenHouse)
                   .WithMany(g => g.Pots)
                   .HasForeignKey(b => b.GreenHouseId)
