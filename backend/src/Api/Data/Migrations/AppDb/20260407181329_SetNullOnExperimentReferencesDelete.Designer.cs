...
namespace Fei.Is.Api.Data.Migrations.AppDb
{
    ...
    [Migration("20260407181329_SetNullOnExperimentReferencesDelete")]
    partial class SetNullOnExperimentReferencesDelete
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Fei.Is.Api.Data.Models.Device", b =>
                {
                    ...
                    b.Property<bool>("SyncedFromEdge")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false);

                    b.Property<Guid?>("SyncedFromEdgeNodeId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("SyncedFromEdgeNodeId");
            ...
            modelBuilder.Entity("Fei.Is.Api.Data.Models.EdgeNode", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("UpdateRateSeconds")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(5);
            ...
            modelBuilder.Entity("Fei.Is.Api.Data.Models.Experiment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("RanJobId")
                        .HasColumnType("uuid");

                    b.Property<Guid?>("RecipeToRunId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Fei.Is.Api.Data.Models.SystemNodeSetting", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("BackfillCursorOffset")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0);

                    b.Property<long?>("BackfillCursorTimestampUnixMs")
                        .HasColumnType("bigint");

                    b.Property<long?>("BackfillCutoffUnixMs")
                        .HasColumnType("bigint");

                    b.Property<DateTime>("CreatedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<int>("DataPointSyncMode")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0);

                    b.Property<string>("HubToken")
                        .HasMaxLength(256)
                        .HasColumnType("character varying(256)");
            ...
            modelBuilder.Entity("Fei.Is.Api.Data.Models.Device", b =>
                {
                    ...
                    b.HasOne("Fei.Is.Api.Data.Models.EdgeNode", "SyncedFromEdgeNode")
                        .WithMany("SyncedDevices")
                        .HasForeignKey("SyncedFromEdgeNodeId")
                        .OnDelete(DeleteBehavior.SetNull);
                    ...
                    b.Navigation("SyncedFromEdgeNode");
                });
            ...
            modelBuilder.Entity("Fei.Is.Api.Data.Models.Experiment", b =>
                {
                    ...
                    b.HasOne("Fei.Is.Api.Data.Models.Job", "RanJob")
                        .WithMany()
                        .HasForeignKey("RanJobId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("Fei.Is.Api.Data.Models.Recipe", "RecipeToRun")
                        .WithMany()
                        .HasForeignKey("RecipeToRunId")
            ...
            modelBuilder.Entity("Fei.Is.Api.Data.Models.EdgeNode", b =>
                {
                    b.Navigation("SyncedDevices");

                    b.Navigation("SyncedTemplates");
                });
