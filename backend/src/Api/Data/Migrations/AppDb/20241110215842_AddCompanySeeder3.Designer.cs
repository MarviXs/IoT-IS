...
namespace Fei.Is.Api.Data.Migrations.AppDb
{
    ...
    [Migration("20241110215842_AddCompanySeeder3")]
    partial class AddCompanySeeder3
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Fei.Is.Api.Data.Models.InformationSystem.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            City = "Příbram",
                            CreatedAt = new DateTime(2024, 11, 10, 21, 58, 42, 10, DateTimeKind.Utc).AddTicks(1371),
                            Dic = "CZ25735641",
                            Ic = "25735641",
                            Psc = "26101",
                            Title = "Petunia s.r.o.",
                            Ulice = "Třemošenská 658",
                            UpdatedAt = new DateTime(2024, 11, 10, 21, 58, 42, 10, DateTimeKind.Utc).AddTicks(1372)
                        },
                        new
                        {
                            Id = 2,
                            City = "Stará Huť",
                            CreatedAt = new DateTime(2024, 11, 10, 21, 58, 42, 10, DateTimeKind.Utc).AddTicks(1416),
                            Dic = "CZ696123003",
                            Ic = "71070877",
                            Psc = "26202",
                            Title = "Štamberková Monika",
                            Ulice = "K Vršíčku 91",
                            UpdatedAt = new DateTime(2024, 11, 10, 21, 58, 42, 10, DateTimeKind.Utc).AddTicks(1416)
                        },
                        new
                        {
                            Id = 3,
                            City = "Dřísy",
                            CreatedAt = new DateTime(2024, 11, 10, 21, 58, 42, 10, DateTimeKind.Utc).AddTicks(1418),
                            Dic = "CZ27469613",
                            Ic = "27469613",
                            Psc = "27714",
                            Title = "Arboeko s.r.o.",
                            Ulice = "Lhota 244",
                            UpdatedAt = new DateTime(2024, 11, 10, 21, 58, 42, 10, DateTimeKind.Utc).AddTicks(1418)
                        },
                        new
                        {
                            Id = 4,
                            City = "Olbramkostel",
                            CreatedAt = new DateTime(2024, 11, 10, 21, 58, 42, 10, DateTimeKind.Utc).AddTicks(1420),
                            Dic = "CZ28282711",
                            Ic = "28282711",
                            Psc = "67151",
                            Title = "Moravol s.r.o.",
                            Ulice = "Olbramkostel 41",
                            UpdatedAt = new DateTime(2024, 11, 10, 21, 58, 42, 10, DateTimeKind.Utc).AddTicks(1420)
                        },
                        new
                        {
                            Id = 5,
                            City = "Horní Benešov",
                            CreatedAt = new DateTime(2024, 11, 10, 21, 58, 42, 10, DateTimeKind.Utc).AddTicks(1421),
                            Dic = "CZ29296721",
                            Ic = "29296721",
                            Psc = "79312",
                            Title = "LM Agroton s.r.o.",
                            Ulice = "Mírová 407",
                            UpdatedAt = new DateTime(2024, 11, 10, 21, 58, 42, 10, DateTimeKind.Utc).AddTicks(1422)
                        },
                        new
                        {
                            Id = 6,
                            City = "Třebechovice pod Orebem",
                            CreatedAt = new DateTime(2024, 11, 10, 21, 58, 42, 10, DateTimeKind.Utc).AddTicks(1423),
                            Dic = "CZ6203071741",
                            Ic = "46212152",
                            Psc = "50346",
                            Title = "Jan Zatloukal - Zahradnictví Blešno",
                            Ulice = "Blešno 127",
                            UpdatedAt = new DateTime(2024, 11, 10, 21, 58, 42, 10, DateTimeKind.Utc).AddTicks(1423)
                        });
                });
