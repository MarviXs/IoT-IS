...
export interface paths {
    ...
    "/system/node-settings": {
         ...
         * @description Updates node type and hub connection settings for edge mode.
         */
    ...
    "/system/edge-nodes": {
         ...
         * @description Adds a new edge node with update rate and an optional token. When token is not provided, it is autogenerated.
         */
    ...
    "/system/edge-nodes/{id}": {
         ...
         * @description Updates edge node name, token, and update rate.
         */
    ...
    "/system/hub-sync/metadata": {
        ...
        put?: never;
        /**
         * Accept edge metadata snapshot payload
         * @description Hub-only internal endpoint for edge authoritative device/template metadata synchronization.
         */
