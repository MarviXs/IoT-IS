...
export interface paths {
    ...
    "/admin/devices": {
        ...
        /** Get all devices for administrators */
        get: operations["GetAdminDevices"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/admin/devices/{id}/owner": {
        ...
        get?: never;
        /** Change device owner */
        put: operations["ChangeDeviceOwner"];
        post?: never;
        delete?: never;
        options?: never;
        head?: never;
    ...
    "/system/node-settings": {
        ...
        /**
         * Get system node settings
         * @description Returns current node type, hub connection settings, and configured edge nodes.
         */
        get: operations["GetNodeSettings"];
        /**
         * Update system node settings
         * @description Updates node type, hub connection settings, and sync interval for edge mode.
         */
        put: operations["UpdateNodeSettings"];
        post?: never;
        delete?: never;
        options?: never;
        head?: never;
    ...
    "/system/edge-nodes": {
        ...
        put?: never;
        /**
         * Create edge node setting
         * @description Adds a new edge node with an optional token. When token is not provided, it is autogenerated.
         */
        post: operations["CreateEdgeNode"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/system/edge-nodes/{id}": {
        ...
        get?: never;
        /**
         * Update edge node setting
         * @description Updates edge node name and token.
         */
        put: operations["UpdateEdgeNode"];
        post?: never;
        /**
         * Delete edge node setting
    ...
    "/system/hub-sync/datapoints": {
         ...
         * @description Hub-only internal endpoint for edge datapoint sync with token authentication. Can request metadata resync via response flag.
         */
    ...
    "/system/hub-sync/metadata": {
        ...
        put?: never;
        /**
         * Accept edge metadata sync payload
         * @description Hub-only internal endpoint for edge authoritative device/template synchronization (full snapshot or delta updates).
         */
        post: operations["HubSyncMetadata"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/system/edge-nodes/sync-all-now": {
        ...
        put?: never;
        /**
         * Force sync for all edge nodes
         * @description Invalidates metadata version for all configured edge nodes.
         */
    ...
    "/system/edge-nodes/{id}/sync-now": {
        ...
        put?: never;
        /**
         * Force sync for one edge node
         * @description Invalidates node metadata version so the node performs metadata sync on next heartbeat.
         */
...
export interface components {
    schemas: {
        ...
        "Fei.Is.Api.Common.Pagination.PagedList`1[[Fei.Is.Api.Features.Devices.Queries.GetAdminDevices.Response, Api, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null]]": {
            ...
            readonly hasPrevious: boolean;
            readonly hasNext: boolean;
            items: components["schemas"]["Fei.Is.Api.Features.Devices.Queries.GetAdminDevices.Response"][];
        };
        ...
        "Fei.Is.Api.Features.Devices.Queries.GetAdminDevices.Response": {
            /** Format: uuid */
            id: string;
            name: string;
            /** Format: uuid */
        ...
        "Fei.Is.Api.Features.System.Commands.CreateEdgeNode.Request": {
            name: string;
            token?: string | null;
        };
        "Fei.Is.Api.Features.System.Commands.CreateEdgeNode.Response": {
            /** Format: uuid */
            id: string;
            name: string;
            token: string;
        ...
        "Fei.Is.Api.Features.System.Commands.UpdateEdgeNode.Request": {
            name: string;
            token: string;
        };
        "Fei.Is.Api.Features.System.Commands.UpdateNodeSettings.Request": {
            nodeType: components["schemas"]["Fei.Is.Api.Data.Enums.SystemNodeType"];
            hubUrl?: string | null;
        ...
        "Fei.Is.Api.Features.System.Queries.GetNodeSettings.EdgeNodeResponse": {
            ...
            /** Format: int32 */
            expectedSyncSeconds?: number | null;
        };
        "Fei.Is.Api.Features.System.Queries.GetNodeSettings.HubConnectionStatusResponse": {
            isOnline: boolean;
            /** Format: date-time */
            lastSyncAt?: string | null;
        };
        "Fei.Is.Api.Features.System.Queries.GetNodeSettings.Response": {
            nodeType: components["schemas"]["Fei.Is.Api.Data.Enums.SystemNodeType"];
            hubUrl?: string | null;
            hubToken?: string | null;
            /** Format: int32 */
        ...
        "Fei.Is.Api.Features.System.Services.SyncDataPointsResponse": {
            ...
            /** Format: int32 */
            skippedCount: number;
            requiresMetadataSync: boolean;
            requiresFullMetadataSync: boolean;
            datapointsProcessed: boolean;
        };
        "Fei.Is.Api.Features.System.Services.SyncMetadataRequest": {
            /** Format: int32 */
            edgeMetadataVersion: number;
            isFullSnapshot: boolean;
            templates: components["schemas"]["Fei.Is.Api.Features.System.Services.SyncedTemplatePayload"][];
            devices: components["schemas"]["Fei.Is.Api.Features.System.Services.SyncedDevicePayload"][];
            deletedTemplateIds: string[];
            deletedDeviceIds: string[];
        };
        "Fei.Is.Api.Features.System.Services.SyncMetadataResponse": {
            /** Format: int32 */
            ...
            /** Format: int32 */
            devicesConflicts: number;
            /** Format: int32 */
            sensorsUpserted: number;
            /** Format: int32 */
            ...
            /** Format: int32 */
            recipeStepsUpserted: number;
            /** Format: int32 */
            recipeStepsDeleted: number;
            /** Format: int32 */
            controlsUpserted: number;
            /** Format: int32 */
            controlsDeleted: number;
            /** Format: int32 */
            skippedOwners: number;
            /** Format: int32 */
            missingTemplateReferences: number;
            /** Format: int32 */
            appliedEdgeMetadataVersion: number;
        };
        "Fei.Is.Api.Features.System.Services.SyncedCommandPayload": {
            /** Format: uuid */
            id: string;
            displayName: string;
            name: string;
        ...
        "Fei.Is.Api.Features.System.Services.SyncedControlPayload": {
            /** Format: uuid */
            id: string;
            name: string;
            color: string;
        ...
        "Fei.Is.Api.Features.System.Services.SyncedDevicePayload": {
            /** Format: uuid */
            id: string;
            name: string;
            mac?: string | null;
        ...
        "Fei.Is.Api.Features.System.Services.SyncedRecipePayload": {
            /** Format: uuid */
            id: string;
            name: string;
            steps: components["schemas"]["Fei.Is.Api.Features.System.Services.SyncedRecipeStepPayload"][];
        };
        "Fei.Is.Api.Features.System.Services.SyncedRecipeStepPayload": {
            /** Format: uuid */
            id: string;
            /** Format: uuid */
            commandId?: string | null;
        ...
        "Fei.Is.Api.Features.System.Services.SyncedSensorPayload": {
            /** Format: uuid */
            id: string;
            name: string;
            tag: string;
        ...
        "Fei.Is.Api.Features.System.Services.SyncedTemplatePayload": {
            /** Format: uuid */
            id: string;
            name: string;
            deviceType: components["schemas"]["Fei.Is.Api.Data.Enums.DeviceType"];
            ...
            gridColumnSpan?: number | null;
            ownerEmail?: string | null;
            sensors: components["schemas"]["Fei.Is.Api.Features.System.Services.SyncedSensorPayload"][];
            commands: components["schemas"]["Fei.Is.Api.Features.System.Services.SyncedCommandPayload"][];
            recipes: components["schemas"]["Fei.Is.Api.Features.System.Services.SyncedRecipePayload"][];
            controls: components["schemas"]["Fei.Is.Api.Features.System.Services.SyncedControlPayload"][];
        };
...
export interface operations {
    ...
    GetAdminDevices: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["Fei.Is.Api.Common.Pagination.PagedList`1[[Fei.Is.Api.Features.Devices.Queries.GetAdminDevices.Response, Api, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null]]"];
                };
            };
        };
    };
    ...
    GetNodeSettings: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["Fei.Is.Api.Features.System.Queries.GetNodeSettings.Response"];
                };
            };
        };
    };
    UpdateNodeSettings: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Fei.Is.Api.Features.System.Commands.UpdateNodeSettings.Request"];
            };
        };
        responses: {
            /** @description No Content */
    ...
    CreateEdgeNode: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Fei.Is.Api.Features.System.Commands.CreateEdgeNode.Request"];
            };
        };
        responses: {
            /** @description Created */
            201: {
                ...
                content: {
                    "application/json": components["schemas"]["Fei.Is.Api.Features.System.Commands.CreateEdgeNode.Response"];
                };
            };
            /** @description Bad Request */
            400: {
    ...
    UpdateEdgeNode: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Fei.Is.Api.Features.System.Commands.UpdateEdgeNode.Request"];
            };
        };
        responses: {
            /** @description No Content */
    ...
    HubSyncMetadata: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Fei.Is.Api.Features.System.Services.SyncMetadataRequest"];
            };
        };
        responses: {
            /** @description OK */
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["Fei.Is.Api.Features.System.Services.SyncMetadataResponse"];
                };
            };
        };
    };
